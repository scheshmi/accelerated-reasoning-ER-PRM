...
from utils.batch_utils import get_batch_size_beam

from core.models import setup_models
from algorithms.beam_search import parallel_beam_search
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run MCTS math problem solving with optional profiling")
    parser.add_argument("--output_dir", type=str, default="MATH500_OUTPUT_beam_search", help="Output directory")
    ...
    parser.add_argument("--search_batch", type=int, default=5, help="Search batch size")
    ...
    parser.add_argument("--profile", action="store_true", help="Enable per-batch profiling")
    ...
    parser.add_argument("--dataset", type=str, default="math500", 
                        choices=["math500", "aime", "amc23", "sat_math"],
    ...
    print(f"Search Batch Size: {args.search_batch}")
    ...
    args.output_dir = f'{dataset_name}_OUTPUT_beam_search_{args.llm_model_name}_{args.prm_model_name}_{args.num_beams}_{args.beam_width}_{args.max_steps}'

    llm, prm_tokenizer, prm_model, prm_type = setup_models(args.llm_model_name, args.prm_model_name)

    if args.dataset == "math500":
        process_math500_dataset(
            search_algorithm=parallel_beam_search,
            ...
            prm_model=prm_model,
            prm_type=prm_type,
            get_batch_size_func=get_batch_size_beam,
